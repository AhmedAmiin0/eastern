...
class CountryController extends AbstractController
{
    ...
    #[OA\Parameter(name: 'offset', description: 'Number of countries to skip for pagination (default: 0)', in: 'query', schema: new OA\Schema(type: 'integer', minimum: 0, default: 0))]
